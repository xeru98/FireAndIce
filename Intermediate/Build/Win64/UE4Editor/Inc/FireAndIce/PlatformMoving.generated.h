...
class AActor;
#ifdef FIREANDICE_PlatformMoving_generated_h
#error "PlatformMoving.generated.h already included, missing '#pragma once' in PlatformMoving.h"
#endif
...
public: \
	DECLARE_CLASS(APlatformMoving, APlatformBase, COMPILED_IN_FLAGS(0), 0, TEXT("/Script/FireAndIce"), NO_API) \
	DECLARE_SERIALIZER(APlatformMoving) \
...
#define FireAndIce_Source_FireAndIce_PlatformMoving_h_15_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, APlatformMoving); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(APlatformMoving); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API APlatformMoving(APlatformMoving&&); \
	NO_API APlatformMoving(const APlatformMoving&); \
public:
